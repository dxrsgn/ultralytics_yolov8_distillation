...
from ultralytics.nn.tasks import DetectionModel, DetectionDistillModel
...
class DistilationDetectionTrainer(DetectionTrainer):
    """
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        self.teacher = overrides['kwargs']["teacher"].model
        self.embeds_s = overrides['kwargs']['embeds_s']
        self.embeds_t = overrides['kwargs']['embeds_t']
        overrides.pop('kwargs')
    ...
    def _setup_train(self, world_size):
        ...
        # Set embeddings and their projections
        self.init_embeds()
    ...
    def get_model(self, cfg=None, weights=None, verbose=True):
        """Return a YOLO detection model."""
        model = DetectionDistillModel(cfg, nc=self.data["nc"], verbose=verbose and RANK == -1)
        if weights:
            model.load(weights)
        return model
